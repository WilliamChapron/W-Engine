...
bool firstMouse = true; // Flag pour la premi�re capture de la souris
float sensitivity = 0.1f; // Sensibilit� de la souris


void ProcessMouseMovement(GLFWwindow* window, Camera& camera) {
    double xpos, ypos;
    glfwGetCursorPos(window, &xpos, &ypos); // R�cup�rer la position actuelle de la souris
    ...
    // Calculer le d�calage de la souris (offset) par rapport � la position pr�c�dente
